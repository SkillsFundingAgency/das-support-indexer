...
namespace SFA.DAS.Support.Shared.Navigation
{
    ...
    {
        public List<MenuItem> TransformMenuTemplates(List<MenuItem> templateItems, Uri baseUrl, Dictionary<string, string> identifiers)
        {
            var templateCopies = JsonConvert.DeserializeObject<List<MenuItem>>(JsonConvert.SerializeObject(templateItems));
