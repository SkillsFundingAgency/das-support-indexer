...
namespace SFA.DAS.Support.Shared.Navigation
{
    ...
    {
        private readonly Dictionary<SupportServiceIdentity, Uri> _serviceAddresses =
            new Dictionary<SupportServiceIdentity, Uri>();
        ...
        {
            if (!_serviceAddresses.Any()) GetAddresses();
